...
class Solution107 {
     ...
     *                           DFS traverse takes O(n), reverse outer list takes O(logn).
     *                           In this case the outer array list size is `logn`.
     *        worst O(2n), for skewed binary tree (Any shape). DFS traverse takes O(n), reverse outer list takes O(n).
