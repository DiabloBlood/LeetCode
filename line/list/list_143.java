...
class Solution143 {
     ...
     *     3. Merge l1 and l2.
     *
     * Notes: why `mid.next = null`?
     *     1. Input 1->2->3->4->null, merge l1: 1->2->3->null and l2: 4->3->null
     *         - l1: 1->4->2->3->null, l2: 3->null
     *         - l1: 1->4->2->3->3, l2: null
     *         - Finally, `3` directs to itself, list has cycle
     *     2. Input 1->2->3->4->5->null, merge l1: 1->2->3->4->null and l2: 5->4->null
     *         - l1: 1->5->2->3->4->null, l2: 4->null
     *         - l1: 1->5->2->4->3->4->4, l2: null
     *         - Finally, `3` directs to itself, list has cycle
     *
     * Corner Cases:
     ...
     * General Cases:
     *     1. l2 != null; ---> merge
     *     2. l2 == null; ---> merge finished, while loop break
     */
